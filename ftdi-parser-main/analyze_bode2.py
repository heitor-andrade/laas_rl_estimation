...
frequences_set_new_line, amplitudes_new_line = get_amplitudes(frequences_new, ids_new)
...
frequences_set_new_line.pop(0)
amplitudes_new_line.pop(0)
...
frequences_set_old, amplitudes_old = get_amplitudes(frequences_old, ids_old)
frequences_set_new_phase, amplitudes_new_phase = get_amplitudes(frequences_new, ids_new)
...
# incomplete current from data
frequences_set_new_phase.pop(0)
amplitudes_new_phase.pop(0)

# # plot data
plt.plot(frequences_set_old, 20*np.log10(amplitudes_old), label = "Code constants")
# plt.plot(frequences_set_new_line, 20*np.log10(amplitudes_new_line), label = "Computed constants [Line to Line]")
plt.plot(frequences_set_new_phase, 20*np.log10(amplitudes_new_phase), label = "Computed constants")
plt.xlabel("Frequence [Hz]")
plt.ylabel("Gain Current [Db]")
plt.title("Frequency response of the current controller")
plt.xscale("log")
plt.grid()
plt.legend()
plt.show()